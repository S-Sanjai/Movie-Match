...
export const ProjectDetails = () => {
    return (
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 pb-12 sm:pb-16 md:pb-20 pt-6 sm:pt-8 md:pt-10">
            <div className="group relative bg-[#1a1a1a] rounded-xl p-4 sm:p-6 md:p-8 border border-white/5 overflow-hidden font-source text-sm shadow-2xl">
                {/* Pixel Canvas Effect */}
                <PixelCanvas
                    gap={20}
                    speed={25}
                ...
                <div className="relative z-10">
                    <h2 className="text-xl sm:text-2xl font-bold font-poppins text-white mb-2 tracking-[3px] sm:tracking-[4px] md:tracking-[5px]">MOVIE MATCH</h2>
                    <p className="text-gray-400 text-xs mb-6 font-mono">Just a cool way to visualize a project in my Machine Learning journey</p>

                    <h3 className="text-green-500 font-bold tracking-wider uppercase text-xs mb-3 sm:mb-4">PROJECT OVERVIEW</h3>

                    <ul className="space-y-3 sm:space-y-4 text-gray-300 text-xs md:text-sm leading-relaxed font-mono">
                        <li>
